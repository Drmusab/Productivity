...
describe('Boards API operations', () => {
    ...
    test('retrieves all boards', async () => {
        await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Board 1', 'Description 1', 0]);
        await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Board 2', 'Description 2', 0]);
    ...
    test('retrieves a specific board by ID', async () => {
        const board = await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Specific Board', 'Specific Description', 0]);
    ...
    test('updates an existing board', async () => {
        const board = await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Original Board', 'Original Description', 0]);
        const updateData = {
            name: 'Updated Board',
    ...
    test('deletes a board', async () => {
        const board = await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Board to Delete', 'Will be deleted', 0]);
    ...
    test('creates a column for a board', async () => {
        const board = await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Board with Column', 'Test', 0]);
        const columnData = {
            name: 'To Do',
            color: '#3498db',
            position: 0
    ...
    test('creates a swimlane for a board', async () => {
        const board = await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Board with Swimlane', 'Test', 0]);
        const swimlaneData = {
    ...
    test('updates a column', async () => {
        const board = await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Board', 'Test', 0]);
        const column = await runAsync('INSERT INTO columns (board_id, name, color, position) VALUES (?, ?, ?, ?)', [board.lastID, 'Old Name', '#000000', 0]);
        const updateData = {
            name: 'New Name',
            color: '#ff0000'
        };
    ...
    test('deletes a column', async () => {
        const board = await runAsync('INSERT INTO boards (name, description, template) VALUES (?, ?, ?)', ['Board', 'Test', 0]);
        const column = await runAsync('INSERT INTO columns (board_id, name, color, position) VALUES (?, ?, ?, ?)', [board.lastID, 'Column to Delete', '#000000', 0]);
        const response = await request(app)
